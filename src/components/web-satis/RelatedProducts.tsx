      ...
      <div className="max-w-[1280px] mx-auto px-6">
        ...
        <div className="grid md:grid-cols-2 gap-5">
          <Link href="/crm" className="card-light hover-lift overflow-hidden group relative p-7 reveal" style={{ minHeight: 260 }}>
            ...
            <h3 className="display text-[26px] mt-5 max-w-[380px]">Sigorta operasyonunu tek ekranda yönet.</h3>
          ...
          <Link href="/#chat" className="hover-lift overflow-hidden group relative p-7 reveal rounded-[20px]" style={{ minHeight: 260, background: "linear-gradient(135deg,#0A0F2C,#0F8E7F)", color: "white" }}>
            ...
            <div className="relative">
              ...
              <h3 className="display text-[26px] mt-5 max-w-[380px]">WhatsApp&apos;ta satış yapan AI asistan.</h3>
              <p className="mt-3 text-white/70 text-[14px] max-w-[380px]">Müşteri niyetini oku, 8 şirketten teklif hazırla, poliçeyi WhatsApp&apos;tan kes.</p>
              <div className="mt-6 flex gap-2 flex-wrap">
                <span className="chip chip-dark" style={{ background: "rgba(255,255,255,.1)" }}>AI niyet tespiti</span>
                <span className="chip chip-dark" style={{ background: "rgba(255,255,255,.1)" }}>7/24 otomasyon</span>
                <span className="chip chip-dark" style={{ background: "rgba(255,255,255,.1)" }}>CRM senkron</span>
              </div>
            </div>
          </Link>
        </div>
